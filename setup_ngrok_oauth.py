#!/usr/bin/env python3
"""
Configurar OAuth con ngrok para ClickUp
"""
...
def install_ngrok():
    ...
    print("3. Extrae ngrok.exe a una carpeta (ej: C:\\ngrok)")
    print("4. Agrega esa carpeta al PATH de Windows")
    print("5. O copia ngrok.exe a esta carpeta del proyecto")
    print()
...
def main():
    """Función principal"""
    print("🎯 CONFIGURANDO OAUTH CON NGROK PARA CLICKUP")
    print("=" * 60)
