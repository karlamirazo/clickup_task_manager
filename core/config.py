...
class Settings(BaseSettings):
    ...
    CLICKUP_OAUTH_CLIENT_ID: str = os.getenv("CLICKUP_OAUTH_CLIENT_ID", "0J2LPSHXIM5PRB5VDE5CRJY7FJP86L0H")
    CLICKUP_OAUTH_CLIENT_SECRET: str = os.getenv("CLICKUP_OAUTH_CLIENT_SECRET", "KJ1GM87ATJ0EOCJFQJMZK1811R95U12Y6324CFY39J38KCGETHIEEVLDDKN38JUQ")
    ...
    # Configuracion de CORS - usando property para manejar parsing robusto
    ...
    def ALLOWED_ORIGINS(self) -> List[str]:
        ...
        # Si no hay valor o está vacío, usar valores por defecto
        if not self.ALLOWED_ORIGINS_RAW or not self.ALLOWED_ORIGINS_RAW.strip():
            return default_origins
        
        # Intentar parsear como JSON
        try:
            parsed = json.loads(self.ALLOWED_ORIGINS_RAW.strip())
    ...
    # FORZANDO DEPLOY COMPLETAMENTE NUEVO EN RAILWAY - 2025-01-31
