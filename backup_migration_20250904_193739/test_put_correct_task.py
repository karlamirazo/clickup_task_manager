#!/usr/bin/env python3
"""
Test del endpoint PUT con la tarea correcta (ID 91)
"""

import requests
import json

def test_put_correct_task():
    """Probar el endpoint PUT con la tarea correcta"""
    
    print("🔍 TEST ENDPOINT PUT CON TAREA CORRECTA")
    print("=" * 60)
    
    # URL del endpoint
    base_url = "https://clickuptaskmanager-production.up.railway.app"
    task_id = "91"  # ID correcto de la tarea simulador
    
    # Datos de actualización
    update_data = {
        "name": "simulador 5",
        "description": "Test con tarea correcta",
        "status": "complete",
        "priority": 1,
        "due_date": "2025-09-05"
    }
