#!/usr/bin/env python3
"""
Verificación final - Ignora warnings de asyncio
"""
...
def test_api_imports():
    ...
    for module in api_imports:
        try:
            ...
            # Ignorar errores de asyncio
            if "no running event loop" in str(e) or "coroutine" in str(e):
                print(f"  OK: {module} (warning asyncio ignorado)")
            else:
                print(f"  ERROR: {module} - {e}")
                all_ok = False
...
def main():
    ...
    print("VERIFICACION FINAL - ClickUp Project Manager")
    print("=" * 60)
